/**
 * @fileoverview Audience view for presentation sessions
 *
 * This page displays the live presentation to audience members. They can view
 * slides in real-time and submit questions/feedback to the presenter.
 *
 * Features:
 * - Real-time slide synchronization (polling every 2 seconds)
 * - Dual sync paths: postMessage for local window, API for remote viewers
 * - Feedback submission modal
 * - Session validation on load
 * - Full-screen slide rendering
 *
 * Communication:
 * - postMessage: Receives slides from presenter's window (if opened locally)
 * - GET /api/sessions/[sessionId]/slide: Polls for slides every 2s (remote viewers)
 * - POST /api/sessions/[sessionId]/feedback: Submits audience questions
 *
 * Audience URL format: /presentation/[sessionId]
 * Generated by presenter when creating session, shared with audience.
 *
 * Session validation:
 * - Validates session exists on mount (HEAD request to feedback endpoint)
 * - Shows error if session not found or expired
 */
...
/**
 * Slide data structure (matches presenter's SlideData interface).
